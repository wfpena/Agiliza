...
using AgilizaScrum.Sessions;
using AgilizaScrum.Web.Controllers.Results;
using AgilizaScrum.Web.Models;
using AgilizaScrum.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace AgilizaScrum.Web.Controllers
{
    public class AccountController : AgilizaScrumControllerBase
    {
